...
/**
 * 関連テーブル：message,mstr_message_define DTO
 */
 ...
 * ==========================================================================
 */
public class PopupMessageListDto implements IMessageBaseDto {

    /** テーブル名 */
    public static final String TABLE_NAME = "message,mstr_message_define";
    ...
    /** メッセージキー名 */
    public static final String MESSAGE_KEY_NAME = "message_key_name";

    /** メッセージ発生元ソース */
    public static final String MESSAGE_ORIGIN_SOURCE = "message_origin_source";

    /** ガイダンスメッセージ文字列 */
    public static final String GUIDANCE_MESSAGE = "guidance_message";
    ...
    /**
     * PopupMessageListDto・コンストラクタ
     */
    public PopupMessageListDto() {
    }
     ...
     */
    public PopupMessageListDto(Date occur_date, String occur_user_id, String occur_user_name, String origin_computer_name, String occur_site_code, String message_no, String resource_id, Integer category, Integer message_level, Integer db_area_div, String message_param1, String message_param2, String message_param3, String message_param4, String message_param5, String message_param6, String message_param7, String message_param8, String message_param9, String message_param10, String operation_type, String message_code, String message_key_name, String message_origin_source, String guidance_message, String link_info, String link_name) {
        super();
