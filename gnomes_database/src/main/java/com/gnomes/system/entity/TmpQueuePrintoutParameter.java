...
@Table(name = "tmp_queue_printout_parameter")
@NamedQueries({
        @NamedQuery(name = "TmpQueuePrintoutParameter.findAll", query = "SELECT p FROM TmpQueuePrintoutParameter p"),
        @NamedQuery(name = "TmpQueuePrintoutParameter.findByPK", query = "SELECT p FROM TmpQueuePrintoutParameter p WHERE p.tmp_queue_data_printout_key = :tmp_queue_data_printout_key")
})
public class TmpQueuePrintoutParameter extends BaseEntity implements Serializable {

    /** テーブル名 */
    public static final String TABLE_NAME = "tmp_queue_printout_parameter";

    /** 印字キューデータキー */
    public static final String COLUMN_NAME_TMP_QUEUE_DATA_PRINTOUT_KEY = "tmp_queue_data_printout_key";
    ...
    /** 印字キューデータキー */
    private String tmp_queue_data_printout_key;
    /** nk印字キューキー (FK) */
    ...
    /**
     * Zi122印字キューパラメータエンティティ コンストラクタ
     */
    public TmpQueuePrintoutParameter() {
    }

    /**
     * Zi122印字キューパラメータエンティティ コンストラクタ
     * @param tmp_queue_data_printout_key 印字キューデータキー
     * @param queue_printout_key nk印字キューキー (FK)
     * @param event_id nk要求イベントID
     * @param request_seq nk要求内連番
     * @param parameter_name nkパラメータ名
     * @param version 更新バージョン
     */
    public TmpQueuePrintoutParameter(String tmp_queue_data_printout_key, String queue_printout_key, String event_id, int request_seq, String parameter_name, int version) {
        this.tmp_queue_data_printout_key = tmp_queue_data_printout_key;
     ...
     * @param version 更新バージョン
     */
    public TmpQueuePrintoutParameter(String tmp_queue_data_printout_key, String queue_printout_key, String event_id, int request_seq, String parameter_name, String parameter_disp_name, String parameter_value, String first_regist_event_id, String first_regist_user_number, String first_regist_user_name, Date first_regist_datetime, String last_regist_event_id, String last_regist_user_number, String last_regist_user_name, Date last_regist_datetime, int version) {
        this.tmp_queue_data_printout_key = tmp_queue_data_printout_key;
        this.queue_printout_key = queue_printout_key;
        this.event_id = event_id;
        this.request_seq = request_seq;
    ...
    public String getTmp_queue_data_printout_key() {
        return this.tmp_queue_data_printout_key;
    }

    /**
     * 印字キューデータキーを設定
     * @param tmp_queue_data_printout_key 印字キューデータキー (null不可)
     */
    public void setTmp_queue_data_printout_key(String tmp_queue_data_printout_key) {
        this.tmp_queue_data_printout_key = tmp_queue_data_printout_key;
    }
    ...
    /**
     * nk印字キューキー (FK)を設定
     * @param queue_printout_key nk印字キューキー (FK) (null不可)
     */
