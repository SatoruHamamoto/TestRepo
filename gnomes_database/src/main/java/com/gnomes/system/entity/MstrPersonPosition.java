...
@Table(name = "mstr_person_position")
@NamedQueries({
        @NamedQuery(name = "MstrPersonPosition.findAll", query = "SELECT p FROM MstrPersonPosition p"),
        @NamedQuery(name = "MstrPersonPosition.findByPK", query = "SELECT p FROM MstrPersonPosition p WHERE p.person_position_key = :person_position_key")
})
public class MstrPersonPosition extends BaseEntity implements Serializable {

    /** テーブル名 */
    public static final String TABLE_NAME = "mstr_person_position";

    /** ユーザ委託階層キー */
    public static final String COLUMN_NAME_PERSON_POSITION_KEY = "person_position_key";
    ...
    /** ユーザ委託階層キー */
    private String person_position_key;
    /** 階層キー (FK) */
    ...
    /**
     * Zm029ユーザ委託階層マスタエンティティ コンストラクタ
     */
    public MstrPersonPosition() {
    }

    /**
     * Zm029ユーザ委託階層マスタエンティティ コンストラクタ
     * @param person_position_key ユーザ委託階層キー
     ...
     */
    public MstrPersonPosition(String person_position_key, String position_key, String user_id, String site_code, String order_process_code, String work_process_code, String work_cell_code, String position_id, int version) {
        this.person_position_key = person_position_key;
    ...
    public String getPerson_position_key() {
        return this.person_position_key;
    }

    /**
     * ユーザ委託階層キーを設定
     * @param person_position_key ユーザ委託階層キー (null不可)
     */
    public void setPerson_position_key(String person_position_key) {
        this.person_position_key = person_position_key;
    }
