...
@Table(name = "hist_change_password_detail")
@NamedQueries({
        @NamedQuery(name = "HistChangePasswordDetail.findAll", query = "SELECT p FROM HistChangePasswordDetail p"),
        @NamedQuery(name = "HistChangePasswordDetail.findByPK", query = "SELECT p FROM HistChangePasswordDetail p WHERE p.hist_change_password_detail_key = :hist_change_password_detail_key")
})
public class HistChangePasswordDetail extends BaseEntity implements Serializable {

    /** テーブル名 */
    public static final String TABLE_NAME = "hist_change_password_detail";
    ...
    /** Zh002パスワード変更履歴 */
    private HistChangePassword histChangePassword;

    /**
     * Zh003パスワード変更履歴詳細エンティティ コンストラクタ
     */
    public HistChangePasswordDetail() {
    }
     ...
     */
    public HistChangePasswordDetail(String hist_change_password_detail_key, String hist_change_password_key, int version) {
    ...
    public HistChangePassword getHistChangePassword() {
        return this.histChangePassword;
    }
     ...
     * @return Zh002パスワード変更履歴
     */ 
    public void setHistChangePassword(HistChangePassword histChangePassword) {
        this.histChangePassword = histChangePassword;
    }
