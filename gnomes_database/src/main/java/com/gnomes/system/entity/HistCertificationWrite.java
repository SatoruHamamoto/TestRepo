...
@Table(name = "hist_certification_Write")
@NamedQueries({
        @NamedQuery(name = "HistCertificationWrite.findAll", query = "SELECT p FROM HistCertificationWrite p"),
        @NamedQuery(name = "HistCertificationWrite.findByPK", query = "SELECT p FROM HistCertificationWrite p WHERE p.hist_certification_key = :hist_certification_key")
})
public class HistCertificationWrite extends BaseEntity implements Serializable {

    /** テーブル名 */
    public static final String TABLE_NAME = "hist_certification_Write";
    ...
    /**
     * Zh001認証履歴（シノニム）エンティティ コンストラクタ
     */
    public HistCertificationWrite() {
    }
     ...
     */
    public HistCertificationWrite(String hist_certification_key, Date occur_datetime, String user_number, String client_device_id, String operation_content, int version) {
     ...
     * @param version 更新バージョン
     */
    public HistCertificationWrite(String hist_certification_key, Date occur_datetime, String user_number, String client_device_id, String operation_content, String user_name, String client_device_name, String ip_address, Integer ng_flag, String ng_detail, String first_regist_event_id, String first_regist_user_number, String first_regist_user_name, Date first_regist_datetime, String last_regist_event_id, String last_regist_user_number, String last_regist_user_name, Date last_regist_datetime, int version) {
        this.hist_certification_key = hist_certification_key;
        this.occur_datetime = occur_datetime;
        this.user_number = user_number;
        this.client_device_id = client_device_id;
