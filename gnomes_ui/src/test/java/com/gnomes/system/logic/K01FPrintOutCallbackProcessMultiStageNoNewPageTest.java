...
class K01FPrintOutCallbackProcessMultiStageNoNewPageTest {
    ...
    @InjectMocks
    K01FPrintOutCallbackProcessMultiStageNoNewPage process;
    ...
    void test_deleteRePrintExcelFile() throws Exception {
        ...
        Method method = K01FPrintOutCallbackProcessMultiStageNoNewPage.class.getDeclaredMethod(TARGET_METHOD);
