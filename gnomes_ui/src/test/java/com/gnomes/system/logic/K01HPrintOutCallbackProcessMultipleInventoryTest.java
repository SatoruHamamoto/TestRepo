...
class K01HPrintOutCallbackProcessMultipleInventoryTest {
    ...
    @InjectMocks
    K01HPrintOutCallbackProcessMultipleInventory process;
    ...
    void test_deleteRePrintExcelFile() throws Exception {
        ...
        Method method = K01HPrintOutCallbackProcessMultipleInventory.class.getDeclaredMethod(TARGET_METHOD);
