...
class K01EPrintOutCallbackProcessMultiStageTest {
    ...
    @InjectMocks
    K01EPrintOutCallbackProcessMultiStage process;
    ...
    void test_deleteRePrintExcelFile() throws Exception {
        ...
        Method method = K01EPrintOutCallbackProcessMultiStage.class.getDeclaredMethod(TARGET_METHOD);
