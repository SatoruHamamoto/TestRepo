...
class K01DPrintOutCallbackProcessMultipleTest {
    ...
    @InjectMocks
    K01DPrintOutCallbackProcessMultiple process;
    ...
    void test_deleteRePrintExcelFile() throws Exception {
        ...
        Method method = K01DPrintOutCallbackProcessMultiple.class.getDeclaredMethod(TARGET_METHOD);
