...
class K01GPrintOutCallbackProcessMultipleMultiStageTest {
    ...
    @InjectMocks
    K01GPrintOutCallbackProcessMultipleMultiStage process;
    ...
    void test_deleteRePrintExcelFile() throws Exception {
        ...
        Method method = K01GPrintOutCallbackProcessMultipleMultiStage.class.getDeclaredMethod(TARGET_METHOD);
