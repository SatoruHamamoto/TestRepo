...
* ==========================================================================
*/
@Named("S01008ServiceFormBean")
@RequestScoped
public class S01008ServiceFormBean implements Serializable, IServiceFormBean {
    ...
    public String getScreenTitle() {
        return ResourcesHandler.getString(GnomesResourcesConstants.SC02_S01008);
    }

    @Override
    @ScreenInfo(name="screenId")
    public String getScreenId() {
        return ScreenIdConstants.SCID_S01008;
    }

    @Override
    @ScreenInfo(name="screenName")
    public String getScreenName() {
        return ResourcesHandler.getString(GnomesResourcesConstants.SC01_S01008);
    }
