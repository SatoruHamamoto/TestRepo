...
@ICommandQualifier(CommandIdConstants.COMMAND_ID_S01005C200)
public class S01005C200 extends ServiceBaseCommand {
    ...
    public void mainExecute() throws Exception {
        ...
        // sendProc
        fileTransferCallBatchlet.sendProcJbatch(externalTargetCode, dupCheck);
    }
