...
@ICommandQualifier(CommandIdConstants.COMMAND_ID_S01005C100)
public class S01005C100 extends ServiceBaseCommand {
    ...
    public void mainExecute() throws Exception {
        ...
        String dataType = paramList.get(0);
        String recvFileName = paramList.get(1);

        // recvRequest
        fileTransferCallBatchlet.recvRequestJbatch(dataType, recvFileName);
    }
