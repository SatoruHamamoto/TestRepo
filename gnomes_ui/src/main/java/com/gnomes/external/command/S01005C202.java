...
@ICommandQualifier(CommandIdConstants.COMMAND_ID_S01005C202)
public class S01005C202 extends ServiceBaseCommand {
    ...
    public void mainExecute() throws Exception {
        ...
        String isSendSuccess =  paramList.get(1);


        // sendResult
        fileTransferCallBatchlet.sendResultJbatch(externalTargetCode, isSendSuccess);
    }
