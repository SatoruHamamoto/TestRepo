 ...
 */
@Dependent
public class HistChangePasswordDetailWriteDao extends BaseDao implements Serializable {
     ...
     * コンストラクタ
     */
    public HistChangePasswordDetailWriteDao() {
    }
    ...
    @TraceMonitor
    @ErrorHandling
    public void insert(HistChangePasswordDetailWrite item, EntityManager eml) {
        if (item != null) {
