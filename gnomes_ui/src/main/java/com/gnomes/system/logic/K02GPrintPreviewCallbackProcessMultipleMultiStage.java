...
import biz.grandsight.ex.rs_multiplemultistage.CReportGen;
import biz.grandsight.ex.rs_multiplemultistage.CReportGenCallback;
import biz.grandsight.ex.rs_multiplemultistage.CReportGenException;
 ...
 * ==========================================================================
 */
public class K02GPrintPreviewCallbackProcessMultipleMultiStage extends CReportGenCallback
{
     ...
     */
    public K02GPrintPreviewCallbackProcessMultipleMultiStage(PrintPreviewCallbackInfo callbackInfo,
    ...
    public String call() throws Exception
    {
        ...
        String servicePath = String.format("http://%s/UI/%s/%s/%s", "localhost", "rest",
                "K02CPrintPreviewCallbackService", "process");
