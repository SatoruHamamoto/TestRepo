 ...
 */
@Dependent
public class PrintOutLogic extends BaseLogic {
     ...
     * @throws GnomesAppException
     */
    protected biz.grandsight.ex.rs_multistage.CReportGen initCReportGenMultiStage(int dbAreaDiv) throws GnomesAppException {
    ...
    protected String getMessage(String reportId) {
        ...
        if (ERROR_REPORT_ID.equals(reportId)) {
            // 帳票印字依頼処理でエラーが発生しました。 GRANSIGHT-EX 帳票処理のログを確認してください。
            return MessagesHandler.getExceptionMessage(super.req,
                    super.exceptionFactory.createGnomesAppException(null, GnomesMessagesConstants.ME01_0165));
     ...
     * @return
     */
    protected PrintOutCallbackInfo setCallbackInfo(String pdfFileName, String printType, String rePrintFileName,
    ...
    protected String getPathName() {
        ...
        try {
            ...
            String message = MessagesHandler.getExceptionMessage(super.req, super.exceptionFactory
                    .createGnomesAppException(null, GnomesMessagesConstants.ME01_0001, new Object[10]));
