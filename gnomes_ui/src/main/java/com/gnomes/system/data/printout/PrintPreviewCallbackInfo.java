 ...
 * ==========================================================================
 */
public class PrintPreviewCallbackInfo extends BaseServiceParam
{
    ...
    /** nk印刷プレビューキューキー */
    private String             queuePrintPreviewKey;
    ...
    public String getQueuePrintPreviewKey()
    {
        return this.queuePrintPreviewKey;
    }

    /**
     * nk印刷プレビューキューキーを設定
     * @param queue_printout_key nk印刷プレビューキューキー (null不可)
     */
    public void setQueuePrintPreviewKey(String queuePrintPreviewKey)
    {
        this.queuePrintPreviewKey = queuePrintPreviewKey;
    }
