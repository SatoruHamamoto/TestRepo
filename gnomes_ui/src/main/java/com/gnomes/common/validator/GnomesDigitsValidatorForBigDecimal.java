 ...
 * ==========================================================================
 */
public class GnomesDigitsValidatorForBigDecimal extends BaseValidator implements ConstraintValidator<GnomesDigits, BigDecimal> {
    ...
    /**
     * 数値桁数バリデータ（数値） コンストラクター
     */
    public GnomesDigitsValidatorForBigDecimal() {
    }
