...
import com.gnomes.common.validator.constraints.GnomesPositiveOrZero;
 ...
 * ==========================================================================
 */
public class GnomesPositiveOrZeroValidatorForNumber implements ConstraintValidator<GnomesPositiveOrZero, Number> {

    /**
     * 数値＜0バリデータ（数値） コンストラクター
     */
    public GnomesPositiveOrZeroValidatorForNumber() {
    }

    @Override
    public void initialize(GnomesPositiveOrZero constraintAnnotation) {
    }
