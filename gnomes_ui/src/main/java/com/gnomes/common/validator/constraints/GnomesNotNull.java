...
import com.gnomes.common.validator.GnomesNotNullValidator;
...
@Constraint(validatedBy = {GnomesNotNullValidator.class})
public @interface GnomesNotNull {
	String message() default GnomesMessagesConstants.MV01_0004;
