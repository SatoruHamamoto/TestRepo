 ...
 * ==========================================================================
 */
public class GnomesPositiveValidatorForNumber implements ConstraintValidator<GnomesPositive, Number> {

    /**
     * 数値≦0バリデータ（数値） コンストラクター
     */
    public GnomesPositiveValidatorForNumber() {
    }

    @Override
    public void initialize(GnomesPositive constraintAnnotation) {
    }
