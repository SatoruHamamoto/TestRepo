 ...
 * ==========================================================================
 */
public class GnomesNegativeOrZeroValidatorForNumber implements ConstraintValidator<GnomesNegativeOrZero, Number> {

    /**
     * 数値＞0バリデーション（数値） コンストラクター
     */
    public GnomesNegativeOrZeroValidatorForNumber() {
    }

    @Override
    public void initialize(GnomesNegativeOrZero constraintAnnotation) {
    }
